...
//3.3 增加 + 按钮
$("#layout").append("<button id='plus' style='float:left;'>+</button>");
$("#plus").bind("click",function(){
    ...
    $("#result").append("<p style='text-align:center'>"+ (totalcount - 1 ) + "<b>+ 1</b> = " + totalcount + "</p>") ; 
});

//3.4 增加 - 按钮
$("#layout").append("<button id='des' style='float:right;'>-</button>");
$("#des").bind("click",function(){
    //从 #tbl 减少元素,事实上。。。
    //不如重置
    totalcount --;
    resetbl(totalcount);
    $("#result").append("<p>" + (totalcount + 1 ) + "<b>- 1</b> = " + totalcount + "</p>"); 
});
